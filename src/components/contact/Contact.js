...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_mm5usdb', 'template_5pz3q6k', form.current, {
                publicKey: 'f2rqax2gPUCw0Qx_S',
            })
            .then(
                () => {
                    console.log('SUCCESS!');
        ...
        <>
            ...
            <motion.div className="contact-container"  {...fadeIn}>
                ...
                <motion.div className="contact-info"  {...fadeIn}>
                    ...
                    <ul>
                        <li><strong>Email:</strong> arthikrajput1034@gmail.com</li>
                        <li><strong>Address:</strong> Gondal, Gujarat.</li>
                    </ul>
                </motion.div>
            </motion.div>
            <ToastContainer />
