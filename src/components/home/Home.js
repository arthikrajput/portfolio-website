        ...
        <>
            <div className="home">
                ...
                <div className="content">
                    ...
                    >
                        Welcome to<br /> <span>Aarthik Kandoliya's</span> Portfolio..
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: -50 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <img src={image} alt="Vraj Chovatiya" className="profile-image" onClick={toggleFullScreen} />
